...
const runConfig = async function (useYarn, yes, exit) {
  ...
  const relativePath = answers.generateTestFiles && answers.usePageObjects ? !(answers.framework === 'cucumber') ? _path.default.relative(destSpecRootPath, destPageObjectRootPath) : _path.default.relative(destStepRootPath, destPageObjectRootPath) : '';
